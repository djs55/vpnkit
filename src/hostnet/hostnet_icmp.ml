...
module Make (Sockets : Sig.SOCKETS) = struct
        ...
        (fun () ->
          ...
          | Ok
              ...
              if Hashtbl.mem t.phys_to_flow (src, id) then (
                ...
                Cstruct.BE.set_uint16 raw 5 id';
                (* TODO: Upstream *)
                Icmpv4_wire.set_checksum raw 0;
                Icmpv4_wire.set_checksum raw
          ...
          | Ok
              ...
              if Hashtbl.mem t.phys_to_flow (dst, id) then (
                ...
                Cstruct.BE.set_uint16 original_icmp 5 id';
                (* TODO: Upstream *)
                Icmpv4_wire.set_checksum original_icmp 0;
                Icmpv4_wire.set_checksum original_icmp
                ...
                Icmpv4_wire.set_checksum icmp_buffer
